const DiscountAndPromot = () => {
  return (
    <div className="flex gap-5">
        <section className="flex flex-col justify-center w-3xs h-100">
            <div className="h-1/2 flex flex-col gap-1.5 justify-center bg-pink-200 rounded-t-2xl p-7">
                <h2 className="text-rose-950 font-extrabold text-lg">Save</h2>
                <h3 className="text-rose-800 font-extrabold text-3xl">$29</h3>
        ...
        <section  className="flex flex-col justify-center w-3xs h-100">
            <div className="h-1/2 flex flex-col gap-1.5 justify-center bg-orange-200 rounded-t-2xl p-7">
                <h2 className="text-orange-950 font-extrabold text-lg">Discount</h2>
                <h3 className="text-orange-900 font-extrabold text-3xl">30%</h3>
                <p className="font-semibold">Enjoy Dicount all types of Grocery & frozen item</p>
            </div>
        ...
        <section className="flex flex-col justify-center w-3xs h-100">
            <div className="h-1/2 flex flex-col gap-1.5 justify-center bg-blue-200 rounded-t-2xl p-7">
                <h2 className="text-blue-900 font-extrabold text-lg">Up tp</h2>
                <h3 className="text-blue-800 font-extrabold text-3xl">50%</h3>
                <p className="font-semibold">Enjoy Dicount all types of Grocery & frozen item</p>
            </div>
        ...
        <section className="flex flex-col justify-center w-3xs h-100">
            <div className="h-1/2 flex flex-col gap-1.5 justify-center bg-purple-200 rounded-t-2xl p-7">
                <h2 className="text-purple-950 font-extrabold text-lg">Free</h2>
                <h3 className="text-purple-900 font-extrabold text-3xl">SHIP</h3>
                <p className="font-semibold">Enjoy Dicount all types of Grocery & frozen item</p>
            </div>
