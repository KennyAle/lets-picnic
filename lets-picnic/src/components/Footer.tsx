...
const Footer = () => {
  return (
    <div className="flex flex-col sm:flex-row sm:items-stretch items-center justify-center bg-yellow-50 px-6 sm:px-12 py-16 gap-10">
      <div className="flex flex-col justify-between w-full sm:w-2/5">
        ...
        <div className="flex flex-col gap-2 mt-6 sm:mt-0">
          <h3 className="font-semibold text-sm text-center sm:text-start">
            Accepted Payments
          </h3>
      ...
      <div className="grid grid-cols-2 sm:flex w-full justify-between gap-6 sm:gap-0">
        <div className="flex flex-col gap-3.5">
          <h3 className="font-semibold">Department</h3>
          <ul className="flex flex-col gap-2 text-sm">
            <li className="hover:underline opacity-80 hover:opacity-100 cursor-pointer">
              Fashion
            </li>
            <li className="hover:underline opacity-80 hover:opacity-100 cursor-pointer">
              Frozen
